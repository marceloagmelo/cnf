...
/**
 * The persistence utility for the pedido moeda digital service. This utility wraps {@link PedidoMoedaDigitalPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class PedidoMoedaDigitalUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(PedidoMoedaDigital pedidoMoedaDigital) {
		getPersistence().clearCache(pedidoMoedaDigital);
	}
	 ...
	 */
	public static List<PedidoMoedaDigital> findWithDynamicQuery(
	 ...
	 */
	public static PedidoMoedaDigital update(
		PedidoMoedaDigital pedidoMoedaDigital) throws SystemException {
		return getPersistence().update(pedidoMoedaDigital);
	}
	 ...
	 */
	public static PedidoMoedaDigital update(
		PedidoMoedaDigital pedidoMoedaDigital, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(pedidoMoedaDigital, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(pedidoMoedaDigital);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(pedidoMoedaDigitals);
	}
	...
	*/
	public static br.com.cnf.curso.inscricao.model.PedidoMoedaDigital create(
		long pedidoMoedaDigitalId) {
		return getPersistence().create(pedidoMoedaDigitalId);
	}
	...
	*/
	public static br.com.cnf.curso.inscricao.model.PedidoMoedaDigital remove(
		long pedidoMoedaDigitalId)
		throws br.com.cnf.curso.inscricao.NoSuchPedidoMoedaDigitalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(pedidoMoedaDigitalId);
	}

	public static br.com.cnf.curso.inscricao.model.PedidoMoedaDigital updateImpl(
		br.com.cnf.curso.inscricao.model.PedidoMoedaDigital pedidoMoedaDigital)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(pedidoMoedaDigital);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static br.com.cnf.curso.inscricao.model.PedidoMoedaDigital findByPrimaryKey(
		long pedidoMoedaDigitalId)
		throws br.com.cnf.curso.inscricao.NoSuchPedidoMoedaDigitalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(pedidoMoedaDigitalId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static br.com.cnf.curso.inscricao.model.PedidoMoedaDigital fetchByPrimaryKey(
		long pedidoMoedaDigitalId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(pedidoMoedaDigitalId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<br.com.cnf.curso.inscricao.model.PedidoMoedaDigital> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static PedidoMoedaDigitalPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (PedidoMoedaDigitalPersistence)PortletBeanLocatorUtil.locate(br.com.cnf.curso.inscricao.service.ClpSerializer.getServletContextName(),
					PedidoMoedaDigitalPersistence.class.getName());

			ReferenceRegistry.registerReference(PedidoMoedaDigitalUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(PedidoMoedaDigitalPersistence persistence) {
	}

	private static PedidoMoedaDigitalPersistence _persistence;
}