...
/**
 * Provides the local service interface for CursoInscricaoCnpj. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author SEA
 * @see CursoInscricaoCnpjLocalServiceUtil
...
public interface CursoInscricaoCnpjLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CursoInscricaoCnpjLocalServiceUtil} to access the curso inscricao cnpj local service. Add custom service methods to {@link br.com.cnf.curso.inscricao.service.impl.CursoInscricaoCnpjLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
