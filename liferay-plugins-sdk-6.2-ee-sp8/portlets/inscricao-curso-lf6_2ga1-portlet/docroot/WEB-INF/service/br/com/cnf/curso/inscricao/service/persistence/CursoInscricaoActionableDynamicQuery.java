 ...
 * @generated
 */
public abstract class CursoInscricaoActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public CursoInscricaoActionableDynamicQuery() throws SystemException {
		setBaseLocalService(CursoInscricaoLocalServiceUtil.getService());
		setClass(CursoInscricao.class);

		setClassLoader(br.com.cnf.curso.inscricao.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("inscricaoId");
	}
}