...
<%@ page import="br.com.cnf.curso.inscricao.util.BreadcrumbsUtil"%>
...
<%@ page import="br.com.cnf.curso.inscricao.model.CursoInscricao"%>
<%@ page import="br.com.cnf.curso.inscricao.model.CursoInscricaoCpf"%>
<%@ page import="br.com.cnf.curso.inscricao.model.CursoInscricaoCnpj"%>
<%@ page import="br.com.cnf.curso.inscricao.model.CursoParticipante"%>

<%@page import="br.com.cnf.curso.inscricao.service.CursoInscricaoCnpjLocalServiceUtil"%>
<%@page import="br.com.cnf.curso.inscricao.model.CursoInscricaoCnpj"%>
...
<c:if test="${not empty msgCursoNaoEncontrado}">
	<liferay-ui:error key="mensagem.erro.conteudoNaoEncontrado"
		message="${msgCursoNaoEncontrado}" />
</c:if>