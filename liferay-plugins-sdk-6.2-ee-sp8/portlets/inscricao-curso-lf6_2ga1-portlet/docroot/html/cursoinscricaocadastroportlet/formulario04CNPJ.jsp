...
<portlet:actionURL name="avancarEtapa04CNPJ" var="avancarURL" />
...
<liferay-ui:error key="mensagem.erro.jaCadastroCurso" message="mensagem.erro.jaCadastroCurso" />
<liferay-ui:error key="mensagem.erro.cargo.obrigatorio" message="mensagem.erro.cargo.obrigatorio" />
<liferay-ui:error key="mensagem.erro.departamento.obrigatorio" message="mensagem.erro.departamento.obrigatorio" />
...
<div class="curso_inscricao">
	...
	<form name="<portlet:namespace />fm" action="<%=avancarURL%>" method="POST">
		...
		<div class="bloco-titulo">
			<h1 class="azul-marinho">
				<liferay-ui:message key="label.quartaEtapaCNPJ" />
			</h1>
			...
			<p>
				...
				<span class="campo-obrigatorio"><liferay-ui:message key="label.obrigatorio" /></span>
				<input type="text" name="<portlet:namespace />razaoSocial" id="razaSocial" value="<%=cursoInscricaoCnpj.getRazaoSocial()%>" disabled />
			</p>
			...
			<p>
				...
				<span class="campo-obrigatorio"><liferay-ui:message key="label.obrigatorio" /></span>
				<input type="text" name="<portlet:namespace />nomeCracha" id="nomeCracha" value="" size="45">
			</p>
			 -->
			<p>
				<label for="cpf">
			...
			<p>
				...
				<span class="campo-obrigatorio">&nbsp;</span>
				(<input style="width: 20px" type="text" name="<portlet:namespace />dddTelefoneSecundario" id="dddTelefoneSecundario" value="" size="1" maxlength="2" onkeyup="moverDeDDDParaTelefone('dddTelefoneSecundario', 'telefoneSecundario')">)
